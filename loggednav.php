...
<html lang="en">
  ...
  <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start bg-dark mb-md-5">
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-10">
          ...
          <li><a href="./posts.php" class="nav-link px-2 link-light">Blog</a></li>
          <li><a href="./contact-us.php" class="nav-link px-2 link-light">Contact us</a></li>
          <li><a href="./about-us.php" class="nav-link px-2 link-light">About us</a></li>
        </ul>

        <div class="dropdown text-end me-md-5">
          <a href="#" class="d-block link-dark text-decoration-none dropdown-toggle " data-bs-toggle="dropdown" aria-expanded="false">
          <span class="text-light"><?php if(isset($_SESSION['name'])){echo $_SESSION['name'];} ?></span> <img src="<?php if(isset($_SESSION['pic'])){echo $_SESSION['pic'];} else{ echo './images/profile.png';}?>" alt="mdo" width="32" height="32" class="rounded-circle" id="nav-pic">
          </a>
          <ul class="dropdown-menu text-small">
            <li><a class="dropdown-item" href="profile.php">Update Profile picture</a></li>
